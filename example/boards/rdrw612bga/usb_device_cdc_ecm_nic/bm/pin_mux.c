...
pin_labels:
- {pin_num: H4, pin_signal: GPIO_21, label: ENET_RST, identifier: ENET_RST}
- {pin_num: K6, pin_signal: GPIO_55, label: ENET_INT, identifier: ENET_INT}
...
- pin_list:
  ...
  - {pin_num: A14, peripheral: ENET, signal: ENET_MDC, pin_signal: GPIO_56}
  - {pin_num: B13, peripheral: ENET, signal: ENET_MDIO, pin_signal: GPIO_57}
  - {pin_num: E11, peripheral: ENET, signal: ENET_TX_EN, pin_signal: GPIO_60}
  ...
  - {pin_num: B14, peripheral: ENET, signal: ENET_RX_EN, pin_signal: GPIO_62}
  - {pin_num: B5, peripheral: ENET, signal: 'ENET_RX_DATA, 1', pin_signal: GPIO_23}
  - {pin_num: A15, peripheral: ENET, signal: ENET_RX_ER, pin_signal: GPIO_63}
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITPINS_ENET_RST_GPIO, BOARD_INITPINS_ENET_RST_PORT, BOARD_INITPINS_ENET_RST_PIN, &ENET_RST_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_ENET_INT_GPIO, BOARD_INITPINS_ENET_INT_PORT, BOARD_INITPINS_ENET_INT_PIN, &ENET_INT_config);
    ...
    /* Initialize ENET_RX functionality on pin GPIO_63, GPIO_22, GPIO_62, GPIO_23 (pin A15_B6_B14_B5) */
    IO_MUX_SetPinMux(IO_MUX_ENET_RX);
    /* Initialize ENET_TX functionality on pin GPIO_60, GPIO_58, GPIO_59 (pin E11_G11_D12) */
    IO_MUX_SetPinMux(IO_MUX_ENET_TX);
    /* Initialize ENET_MDIO functionality on pin GPIO_56, GPIO_57 (pin A14_B13) */
