...
#define USB_DEVICE_CDC_ECM_COMM_INTERFACE_CLASS_CODE (USB_DEVICE_CDC_COMM_CLASS)
#define USB_DEVICE_CDC_ECM_COMM_INTERFACE_SUBCLASS_CODE (USB_DEVICE_CDC_COMM_SUBCLASS_ECM)
#define USB_DEVICE_CDC_ECM_COMM_INTERFACE_PROTOCOL_CODE (USB_DEVICE_CDC_COMM_PROTOCOL_UNUSED)
...
#define USB_DEVICE_CDC_ECM_DATA_INTERFACE_CLASS_CODE (USB_DEVICE_CDC_DATA_CLASS)
#define USB_DEVICE_CDC_ECM_DATA_INTERFACE_SUBCLASS_CODE (USB_DEVICE_CDC_DATA_SUBCLASS_UNUSED)
#define USB_DEVICE_CDC_ECM_DATA_INTERFACE_PROTOCOL_CODE (USB_DEVICE_CDC_DATA_PROTOCOL_UNUSED)
...
#define USB_DEVICE_CDC_FUNC_UNION_SUBTYPE (USB_DEVICE_CDC_FUNC_SUBTYPE_UNION)
